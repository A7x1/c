...
const youtube = new YouTube("AIzaSyAYlcvFqBHYSAfl44IiP5Q7vc5W3GWyemQ"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAYlcvFqBHYSAfl44IiP5Q7vc5W3GWyemQ"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@677849449338241035>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "قيف اواي")) {
...
client.on("message", message => {
  if (message.content === "ip") {
    message.channel.send("- Press F8 Then type : [ connect cfx.re/join/7bkoab ] Welcome ! :cukur23~1:");
    message.channel.sendFile("");
  }
});
////تعديل غير اساسي
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setVc")) {
    ...
    channelfind.setName(
      `فويز اونلاين ${message.guild.members.filter(m => m.voiceChannel).size}` ///تعديل غير اساسي تعديل اسم روم الفويس اونلاين
    );
    ...
    async function handleVideo(video, msg, voiceChannel, playlist = false) {
      ...
      if (!serverQueue) {
        const queueConstruct = {
          ...
          volume: 30, //// تعديل درجة الصوت الاساسية
